...
client_id = '759ceae4-c395-4310-ba04-495e07030ae4'
client_secret = 'e3_poTfbk[YVU4KMkRh1FCBARPNT6][r'
...
def get_token_from_code(auth_code, redirect_uri):
    ...
    try:
        ...
        return 'Error retrieving the token: {0} - {1}'.format(r.status_code, r.text)
